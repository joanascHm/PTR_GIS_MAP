...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-200365.052045, -4439388.602388, 6679446.744149, -224.408662], maxZoom: 9, minZoom: 3
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-200365.052045, -4439388.602388, 6679446.744149, -224.408662], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Gridmap GIS</h2>';
        return titleElement;
    })(),
