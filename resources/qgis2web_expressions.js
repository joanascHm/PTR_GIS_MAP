...
function exp_Roadmaps_7rule0_eval_expression(context) {
    // Status = 'Next'
...
function exp_Roadmaps_7rule1_eval_expression(context) {
    // Status = 'Realesed'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Status')  == 'Realesed');
    } else {
        return (feature.get('Status')  == 'Realesed');
    }
}
...
function exp_Roadmaps_7rule2_eval_expression(context) {
    // Status = 'Future Release'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Status')  == 'Future Release');
    } else {
        return (feature.get('Status')  == 'Future Release');
    }
}
...
function exp_Roadmaps_7rule3_eval_expression(context) {
    // Status = 'No'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Status')  == 'No');
    } else {
        return (feature.get('Status')  == 'No');
    }
}